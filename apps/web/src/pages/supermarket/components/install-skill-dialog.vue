    ...
    <DialogContent class="sm:max-w-lg">
      ...
      <div class="space-y-4 py-2">
        <div class="space-y-1.5">
          ...
          <BotSelect v-model="selectedBotId" trigger-class="w-full" />
        </div>

        <div v-if="skill" class="rounded-md border border-border p-3 space-y-1">
          ...
          <p v-if="skill.files?.length" class="text-[11px] text-muted-foreground">
      ...
      <DialogFooter>
        ...
        <Button :disabled="!selectedBotId || installing" @click="handleInstall">
          <Spinner v-if="installing" class="mr-2 size-4" />
