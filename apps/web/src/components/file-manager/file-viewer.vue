...
<template>
  <div class="relative flex h-full flex-col overflow-hidden">
    ...
    <div class="flex-1 min-h-0 overflow-hidden">
      ...
      <MonacoEditor v-else-if="isText" v-model="content" :filename="filename" class="h-full" />

      <div
        v-else-if="isImage && imageUrl"
        class="flex h-full items-center justify-center overflow-auto p-4 bg-muted/30"
      >
        <img :src="imageUrl" :alt="filename" class="max-h-full max-w-full object-contain rounded" />
      </div>
