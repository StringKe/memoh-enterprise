...
const (
	...
	HealthServiceName = "memoh.private.v1.HealthService"
)
...
const (
	...
	HealthServicePingProcedure = "/memoh.private.v1.HealthService/Ping"
	// HealthServiceHealthProcedure is the fully-qualified name of the HealthService's Health RPC.
	HealthServiceHealthProcedure = "/memoh.private.v1.HealthService/Health"
)

// HealthServiceClient is a client for the memoh.private.v1.HealthService service.
type HealthServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
	Health(context.Context, *connect.Request[v1.HealthRequest]) (*connect.Response[v1.HealthResponse], error)
}

// NewHealthServiceClient constructs a client for the memoh.private.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_memoh_private_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Ping calls memoh.private.v1.HealthService.Ping.
...
// Health calls memoh.private.v1.HealthService.Health.
...
// HealthServiceHandler is an implementation of the memoh.private.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/memoh.private.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("memoh.private.v1.HealthService.Ping is not implemented"))
}
...
func (UnimplementedHealthServiceHandler) Health(context.Context, *connect.Request[v1.HealthRequest]) (*connect.Response[v1.HealthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("memoh.private.v1.HealthService.Health is not implemented"))
}
