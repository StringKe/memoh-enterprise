...
func (p *BrowserProvider) ensureCDP(ctx context.Context, botID string) (*executorclient.Client, error) {
	if p.containers == nil {
		return nil, errors.New("workspace container provider is not configured")
	}
	client, err := p.containers.ExecutorClient(ctx, botID)
	if err != nil {
		return nil, err
	}
...
func (p *BrowserProvider) cdpReachable(ctx context.Context, client *executorclient.Client) bool {
...
func (*BrowserProvider) startDesktopBrowser(ctx context.Context, client *executorclient.Client) error {
	const script = `set -eu
export DISPLAY=:99
...
func (*BrowserProvider) cdpHTTP(ctx context.Context, client *executorclient.Client, method, path string, body io.Reader) ([]byte, int, error) {
...
func (p *BrowserProvider) listTargets(ctx context.Context, client *executorclient.Client) ([]cdpTarget, error) {
...
func (p *BrowserProvider) activeTarget(ctx context.Context, client *executorclient.Client) (cdpTarget, error) {
	targets, err := p.listTargets(ctx, client)
	if err != nil {
...
func (p *BrowserProvider) createOrActiveTarget(ctx context.Context, client *executorclient.Client, targetURL string) (cdpTarget, error) {
...
func (p *BrowserProvider) createTarget(ctx context.Context, client *executorclient.Client, targetURL string) (cdpTarget, error) {
	if strings.TrimSpace(targetURL) == "" {
...
func (p *BrowserProvider) activateTarget(ctx context.Context, client *executorclient.Client, id string) error {
...
func (p *BrowserProvider) closeTarget(ctx context.Context, client *executorclient.Client, id string) (any, error) {
...
func (*BrowserProvider) dialCDP(ctx context.Context, client *executorclient.Client, target cdpTarget) (*cdpConn, error) {
...
func (p *BrowserProvider) connectPage(ctx context.Context, botID string) (*executorclient.Client, cdpTarget, *cdpPage, error) {
	client, err := p.ensureCDP(ctx, botID)
	if err != nil {
...
func (p *BrowserProvider) runCDPTabAction(ctx context.Context, client *executorclient.Client, action string, args map[string]any) (map[string]any, error) {
	switch action {
	case "tab_new":
		targetURL := StringArg(args, "url")
