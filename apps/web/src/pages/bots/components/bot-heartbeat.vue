<template>
  <SettingsShell width="wide" class="space-y-6">
    ...
    <div class="space-y-4">
      ...
      <div v-if="settingsForm.heartbeat_enabled" class="grid gap-4 md:grid-cols-2">
        <div class="space-y-2">
    ...
    <template v-else>
        ...
        <table class="w-full text-xs">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-2">
                <span v-if="log.status === 'error'" class="text-destructive">{{
                  log.error_message || $t("bots.heartbeat.noResult")
                }}</span>
                <span v-else>{{
                  truncateText(log.result_text) || $t("bots.heartbeat.noResult")
                }}</span>
              </td>
            </tr>
          </tbody>
      ...
      >
        ...
        <p v-if="log.error_message" class="text-destructive mt-2">
          {{ log.error_message }}
        </p>
        <p v-if="log.usage" class="text-muted-foreground mt-2 text-xs">
