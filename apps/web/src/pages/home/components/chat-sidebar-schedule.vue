        ...
        <ScrollArea class="h-full">
          <div class="px-2 py-2">
            ...
            >
              ...
              <Button variant="outline" size="sm" class="mt-3 text-xs h-7" @click="goToSettings()">
            ...
            <div v-else class="flex flex-col gap-1">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div
                    class="flex items-center gap-1.5 text-[11px] text-muted-foreground leading-[14px]"
                  >
                    <span class="truncate font-mono">
                      {{ item.description || item.pattern || "--" }}
                    </span>
                    <span v-if="callsLabel(item)" class="shrink-0 tabular-nums">
                      · {{ callsLabel(item) }}
                    </span>
                  </div>
                </div>
