<template>
  <Item variant="outline" class="h-full flex-col items-stretch min-w-0">
    <ItemContent class="w-full min-w-0">
      <ItemTitle class="flex items-center gap-2 w-full min-w-0">
        ...
        <Badge v-if="model.type" variant="outline" size="sm" class="inline-flex items-center gap-1">
        ...
        <Spinner v-if="testLoading" class="size-3.5" />
      </ItemTitle>
