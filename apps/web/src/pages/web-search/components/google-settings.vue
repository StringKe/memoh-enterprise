<template>
  <div class="grid gap-4 md:grid-cols-2">
    ...
    <div class="space-y-2">
      ...
      <Input id="google-cx" v-model="localConfig.cx" aria-label="Search Engine ID" />
    </div>
    <div class="space-y-2">
    ...
    <div class="space-y-2 md:col-span-2">
      ...
      <Input id="google-base-url" v-model="localConfig.base_url" aria-label="Base URL" />
    </div>
  </div>
</template>
...
import { Input, Label } from "@stringke/ui";
...
watch(
  ...
  (val) => {
    ...
    localConfig.base_url = String(
      val?.base_url ?? "https://customsearch.googleapis.com/customsearch/v1",
    );
