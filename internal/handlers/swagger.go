...
//go:generate go run github.com/swaggo/swag/cmd/swag@latest init -g swagger.go -o ../../api/openapi --parseDependency --parseInternal
...
func (*SwaggerHandler) Spec(c echo.Context) error {
	swaggerOnce.Do(func() {
		swaggerSpec, swaggerErr = os.ReadFile("api/openapi/swagger.json")
	})
	if swaggerErr != nil {
