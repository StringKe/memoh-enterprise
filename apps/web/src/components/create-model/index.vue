    ...
    >
      ...
      <template #body>
        <div class="flex flex-col gap-3 mt-4">
          <!-- Type -->
          <FormField v-if="!hideType" v-slot="{ componentField }" name="type">
            <FormItem>
              <Label class="mb-2">
                {{ $t("common.type") }}
              </Label>
              <FormControl>
                <Select v-bind="componentField">
                  <SelectTrigger class="w-full" :aria-label="$t('common.type')">
          ...
          <!-- Model -->
          <FormField v-slot="{ componentField }" name="model_id">
            <FormItem>
              <Label class="mb-2">
                {{ $t("models.model") }}
              </Label>
...
const isLoading = computed(
  () => createLoading.value || updateLoading.value || updateLegacyLoading.value,
);
