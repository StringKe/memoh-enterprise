...
- **[Bot Group](/zh/getting-started/bot-groups)**：共享默认设置并管理按字段继承。
...
- **[Integration WebSocket](/zh/getting-started/integration-websocket)**：使用 scoped API token 和 SDK 接入企业外部集成。
