  ...
  <SettingsShell width="standard">
    ...
    <form @submit="handleSave">
      <div class="grid gap-4 md:grid-cols-2">
        ...
        <FormField v-slot="{ value, handleChange }" name="core">
          <FormItem class="md:col-span-2">
        ...
        <FormField v-slot="{ componentField }" name="viewportWidth">
          <FormItem>
        ...
        <FormField v-slot="{ componentField }" name="viewportHeight">
          <FormItem>
        ...
        <FormField v-slot="{ componentField }" name="deviceScaleFactor">
          <FormItem>
        ...
        <FormField v-slot="{ value, handleChange }" name="timezoneId">
          <FormItem class="md:col-span-2">
        ...
        <div class="md:col-span-2 flex items-center gap-4">
          <FormField v-slot="{ value, handleChange }" name="isMobile">
          ...
          <FormField v-slot="{ value, handleChange }" name="ignoreHTTPSErrors">
            <FormItem class="flex items-center gap-2">
              <FormControl>
                <Switch :model-value="value" @update:model-value="handleChange" />
              </FormControl>
