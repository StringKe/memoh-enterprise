  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        ...
        <Badge v-if="schedules.length" variant="secondary" class="text-xs">
          {{ schedules.length }}
        </Badge>
      </div>
      <div class="flex items-center gap-2">
        ...
        <Button v-if="!formVisible" size="sm" @click="handleNew">
    ...
    <!-- Inline form -->
    <div v-if="formVisible" class="rounded-md border p-4 space-y-4">
      <div class="flex items-center justify-between">
        <h4 class="text-sm font-medium">
          {{ formMode === "create" ? $t("bots.schedule.create") : $t("bots.schedule.edit") }}
        </h4>
        <Button variant="ghost" size="icon-sm" class="size-7" @click="handleFormCancel">
          <X class="size-4" />
        </Button>
      </div>
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-end gap-3">
            ...
            <div class="flex items-center gap-2 h-9 shrink-0">
              <Label class="cursor-pointer text-xs" @click="form.enabled = !form.enabled">
          ...
          <div class="space-y-1.5">
            <Label for="schedule-description" class="flex items-center gap-1.5">
          ...
          <div class="flex justify-end gap-2 pt-2">
            <Button type="button" variant="outline" size="sm" @click="handleFormCancel">
              {{ $t("common.cancel") }}
            </Button>
            <Button type="submit" size="sm" :disabled="!canSubmit || isSaving">
              <Spinner v-if="isSaving" class="mr-1" />
    ...
    >
      ...
      <Button size="sm" variant="outline" @click="handleNew">
        <Plus class="mr-1 size-4" />
        {{ $t("bots.schedule.create") }}
      </Button>
    </div>
              ...
              <td class="px-4 py-2 align-top">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-xs text-muted-foreground">
                    {{
                      item.enabled
                        ? $t("bots.schedule.statusEnabled")
                        : $t("bots.schedule.statusDisabled")
                    }}
                  </span>
                </div>
              </td>
        ...
        >
          <PaginationContent v-slot="{ items }">
            ...
            <template v-for="(item, index) in items" :key="index">
              ...
              <PaginationItem v-else :value="item.value" :is-active="item.value === currentPage" />
            </template>
            <PaginationNext />
            <PaginationLast />
          </PaginationContent>
