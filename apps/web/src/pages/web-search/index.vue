...
<template>
  <MasterDetailSidebarLayout>
    <template #sidebar-content>
      <SidebarMenu v-for="item in curFilterProvider" :key="item.name">
        <SidebarMenuItem>
          <SidebarMenuButton as-child class="justify-start py-5! px-4">
            ...
            >
              <span class="relative shrink-0">
                <SearchProviderLogo :provider="item.provider || ''" size="sm" />
                <Badge
    ...
    <template #detail>
      ...
      <Empty v-else class="h-full flex justify-center items-center">
        ...
        <EmptyContent>
          <Button variant="outline" @click="openStatus.addOpen = true">
