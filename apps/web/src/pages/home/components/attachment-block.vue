<template>
  <div class="flex flex-wrap gap-2">
    <template v-for="(att, i) in block.attachments" :key="i">
      ...
      >
        <audio controls preload="metadata" class="w-full" :src="getUrl(att)" />
      </div>
      ...
      >
        <component :is="fileIconComponent(att)" class="size-4 text-muted-foreground" />
      ...
      >
        <component :is="fileIconComponent(att)" class="size-4" />
        <span class="truncate max-w-[200px]">
