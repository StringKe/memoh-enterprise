    ...
    <div class="flex-1 relative">
      <MasterDetailSidebarLayout class="[&_td:last-child]:w-45">
        <template #sidebar-content>
          <SidebarMenu v-for="tab in tabList" :key="tab.value">
            <SidebarMenuItem>
        ...
        <template #detail>
          <div class="absolute inset-0 overflow-y-auto">
            <div class="p-4">
              <KeepAlive>
                <component :is="activeComponent?.component" v-bind="activeComponent?.params" />
              </KeepAlive>
            </div>
          </div>
        </template>
...
const tabList = computed(() => {
  ...
  const tabs = [
    {
      value: "overview",
      label: "bots.tabs.overview",
      component: BotOverview,
      params: {},
    },
    {
      value: "general",
      label: "bots.tabs.general",
      component: BotSettings,
      params: { "bot-id": bot_id, "bot-type": bot.value?.type },
    },
    ...
    {
      value: "channels",
      label: "bots.tabs.channels",
      component: BotChannels,
      params: { "bot-id": bot_id },
    },
    {
      value: "access",
      label: "bots.tabs.access",
      component: BotAccess,
      params: { "bot-id": bot_id, "bot-type": bot.value?.type },
    },
    {
      value: "tool-approval",
      label: "bots.tabs.toolApproval",
      component: BotToolApproval,
      params: { "bot-id": bot_id },
    },
    ...
    {
      value: "heartbeat",
      label: "bots.tabs.heartbeat",
      component: BotHeartbeat,
      params: { "bot-id": bot_id },
    },
    {
      value: "compaction",
      label: "bots.tabs.compaction",
      component: BotCompaction,
      params: { "bot-id": bot_id },
    },
    {
      value: "schedule",
      label: "bots.tabs.schedule",
      component: BotSchedule,
      params: { "bot-id": bot_id },
    },
    {
      value: "skills",
      label: "bots.tabs.skills",
      component: BotSkills,
      params: { "bot-id": bot_id },
    },
  ];
