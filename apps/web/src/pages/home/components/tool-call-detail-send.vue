<template>
  <div class="space-y-1.5">
    ...
    <div v-if="attachments.length" class="space-y-0.5">
      ...
      <ul class="space-y-0.5">
        ...
        >
          ...
          <span class="font-mono truncate" :title="att">{{ att }}</span>
        </li>
      </ul>
    </div>

    <div v-if="replyTo" class="flex items-center gap-1.5 text-xs text-muted-foreground">
      ...
      <span class="font-mono truncate" :title="replyTo">{{ replyTo }}</span>
    </div>

    <p v-if="!text && !attachments.length && !replyTo" class="text-xs text-muted-foreground italic">
