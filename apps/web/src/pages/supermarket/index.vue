  ...
  <div class="p-6 max-w-6xl mx-auto space-y-6">
    ...
    <div class="space-y-4">
      ...
      <div v-if="activeTag" class="flex items-center gap-2">
        <Badge variant="secondary" class="gap-1">
          ...
          <button class="ml-1 hover:text-destructive" @click="clearTag">
            <X class="size-3" />
          </button>
        </Badge>
      </div>
    ...
    <Tabs default-value="skills" class="w-full">
      ...
      <TabsContent value="skills">
        ...
        <div v-else-if="!skills.length" class="py-8 text-center text-xs text-muted-foreground">
      ...
      <TabsContent value="mcp">
        ...
        <div v-else-if="!mcps.length" class="py-8 text-center text-xs text-muted-foreground">
    ...
    <!-- Install Dialogs -->
    <InstallMcpDialog v-model:open="mcpDialogOpen" :mcp="selectedMcp" />
    <InstallSkillDialog
