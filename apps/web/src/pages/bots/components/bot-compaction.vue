<template>
  <SettingsShell width="wide" class="space-y-6">
    ...
    <div class="space-y-4">
      ...
      <div v-if="settingsForm.compaction_enabled" class="grid gap-4 md:grid-cols-2">
        <div class="space-y-2">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-3">
            ...
            <span class="text-sm text-muted-foreground w-10 text-right tabular-nums"
              >{{ settingsForm.compaction_ratio }}%</span
            >
          </div>
        </div>
    ...
    >
      <div class="rounded-full bg-muted p-3 mb-4">
        <Minimize2 class="size-6 text-muted-foreground" />
      </div>
    ...
    <template v-else>
        ...
        <table class="w-full text-xs">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-2">
                <span v-if="log.error_message" class="text-destructive">{{
                  log.error_message
                }}</span>
              </td>
            </tr>
      ...
      >
        <p v-if="log.error_message" class="text-destructive">
          {{ log.error_message }}
        </p>
