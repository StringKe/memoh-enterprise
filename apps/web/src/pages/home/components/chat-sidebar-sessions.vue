      ...
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          <button class="flex items-center gap-1">
            <component :is="filterIconComponent" class="size-2.5" :class="filterIconClass" />
        ...
        <DropdownMenuContent align="start">
          ...
          >
            <Check v-if="filterType === opt.value" class="size-3 mr-2 absolute" />
            <span class="ml-5">
              {{ opt.label }}
            </span>
          </DropdownMenuItem>
    ...
    <div class="flex-1 relative min-h-0">
      <div class="absolute inset-0">
        <ScrollArea class="h-full">
          ...
          <div v-if="loadingChats" class="flex justify-center py-4">
    ...
    <Dialog v-model:open="deleteSessionDialogOpen">
      <DialogContent class="sm:max-w-md">
        ...
        <DialogFooter>
          ...
          >
            <LoaderCircle v-if="deleteSessionLoading" class="mr-1 size-3 animate-spin" />
            {{ t("common.confirm") }}
          </Button>
        </DialogFooter>
      </DialogContent>
